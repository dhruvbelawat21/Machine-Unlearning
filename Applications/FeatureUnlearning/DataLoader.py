...
class DataLoader:
    ...
    def __init__(self, dataset_name, normalize_data=False):
        ...
        # get absolute path of project root (MachineUnlearning-main)
        PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))

        # dataset paths
        datapaths = {
            'Adult': os.path.join(PROJECT_ROOT, 'train_test_data', 'Adult'),
            'Diabetis': os.path.join(PROJECT_ROOT, 'train_test_data', 'Diabetis'),
            'Enron': os.path.join(PROJECT_ROOT, 'train_test_data', 'Enron'),
            'Drebin': os.path.join(PROJECT_ROOT, 'train_test_data', 'Drebin'),
        }
        ...
        # extension depending on dataset
